      ...
      <div class="cov-date-body">
        <div class="cov-date-monthly">
          ...
          <div class="cov-date-caption" :style="{'color': option.color ? option.color.headerText : '#fff'}">
            <span @click="showYear"><small>{{checked.year}}年</small></span>
            <br>
        ...
        <div class="button-box">
          <span @click="showInfo.check=false">{{option.buttons? option.buttons.cancel : 'キャンセル' }}</span>
          <span @click="picked">{{option.buttons? option.buttons.ok : '確認'}}</span>
        </div>
      </div>
    </div>
  </div>
